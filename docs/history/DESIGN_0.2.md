# Historical design — early 0.2 series

This archived design predates later progression, terrain, and travel changes. See [current design](../DESIGN.md) and [player guide](../PLAYER_GUIDE.md).
